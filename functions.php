...
function my_theme_assets() {
    // اضافه کردن فایل CSS
    wp_enqueue_style( 'my-theme-style1', get_template_directory_uri() . '/assets/css/app.css', array(), '1.0', 'all' );
...
/*
function polylang_tanslate_incompatible_strings($translated,$untranslated,$domain)
{
    if($domain==='WordPresss'){
        return pll__($translated);
    }
}
*/

add_filter('WordPress','WordPressd',9999,3);
add_action('init', function (){
    pll_register_string('WordPresss', '77777777777', 'WordPresss', true);
    pll_register_string('WordPresss', 'Welcomegdfg', 'WordPresss', false);
    pll_register_string('about-us', 'about-us', 'Mojib-academic', false);
    pll_register_string('about-us-description', 'about-us-description', 'Mojib-academic', false);
    pll_register_string('why-us', 'why-us', 'Mojib-academic', false);
},9999);
